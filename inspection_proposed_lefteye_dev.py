...
import nin
import numpy as np
import proposed_nin_ini_lefteye_dev as ni
...
def inspection(path):
	...
	parser.add_argument('--model','-m',default='proposed_lefteye_model')
	parser.add_argument('--mean', default='proposed_lefteye_mean.npy')
