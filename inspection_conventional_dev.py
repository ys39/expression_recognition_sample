...
import nin
import numpy as np
import conventional_nin_ini_dev as ni
...
def inspection(path):
	...
	parser.add_argument('--model','-m',default='conventional_face_model')
	parser.add_argument('--mean', default='conventional_face_mean.npy')
