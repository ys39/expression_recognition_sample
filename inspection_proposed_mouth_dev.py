...
import nin
import numpy as np
import proposed_nin_ini_mouth_dev as ni
...
def inspection(path):
	...
	parser.add_argument('--model','-m',default='proposed_mouth_model')
	parser.add_argument('--mean', default='proposed_mouth_mean.npy')
